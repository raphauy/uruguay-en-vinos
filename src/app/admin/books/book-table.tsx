...
export function DataTableToolbar<TData>({ table, cities }: DataTableToolbarProps<TData>) {
  ...
  return (
    <div className="flex gap-1 dark:text-white items-center">
      ...
      <Input className="max-w-xs" placeholder="name, email, address, phone, number filter..."
...
export function DataTable<TData, TValue>({
  ...
  return (
    <div className="w-full space-y-4 dark:text-white">
      <DataTableToolbar table={table} cities={cities}/>
